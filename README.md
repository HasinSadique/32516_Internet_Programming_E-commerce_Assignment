...
When making this website, some parts were quite hard. Connecting data together in the pages was challenging at first. Making the admin and user UI different was a little confusing. Also, keeping the design working for both mobile and desktop took some time. I learnt more about how Nextjs handles routing and data. Now the site works fast and looks neat, solving the main problems for the organisation and it's customers.
